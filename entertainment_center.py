...
prince_of_egypt = media.Movie(
	"Prince of Egypt",
	"An Egyptian prince learns of his identity as a Hebrew and his destiny to"
        " become the chosen deliverer of his people.",
...
patterns_of_evidence = media.Movie(
	...
	"What is the validity of history found in the Bible? Is it fact or fiction?"
        " What does the hard evidence really have to say about the foundational"
        " story of the Old Testament: the Exodus...",
...
indie_game = media.Movie(
	"Indie Game",
	"A documentary that follows the journeys of indie game developers as they"
...
batman_begins = media.Movie(
	...
	"After training with his mentor, Batman begins his fight to free"
        " crime-ridden Gotham City from the corruption that Scarecrow and"
        " the League of Shadows have cast upon it.",
...
jago = media.Movie(
	...
	"An award-winning documentary about Rohani, an 80-year-old hunter"
        " who dives on a single breath descending to great depths for several"
        " minutes. Set against the spectacular backdrop of the Togian Islands"
        " of Indonesia.",
...
sound_of_music = media.Movie(
	"Sound of Music",
	"A woman leaves an Austrian convent to become a governess to the children"
...
the_grand_budapest_hotel = media.Movie(
	"The Grand Budapest",
	"The adventures of Gustave H, a legendary concierge at a famous hotel from"
        " the fictional Republic of Zubrowka between the first and second World "
...
the_last_samurai = media.Movie(
	"The Last Samurai",
	"An American military advisor embraces the Samurai culture he was hired to"
...
samurai_jack = media.Movie(
	"Samurai Jack",
	"A samurai warrior fights against the evil entity that took him away from"
        " his home world.",
...
the_great_dictator = media.Movie(
	"The Great Dictator",
	"Dictator Adenoid Hynkel tries to expand his empire while a poor Jewish"
        " barber tries to avoid persecution from Hynkel's regime.",
